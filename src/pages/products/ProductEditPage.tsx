...
export function ProductEditPage() {
  const [productState, productDispatch] = useReducer<Reducer<ProductState, ProductAction>>(
    productReducer,
    new ProductState()
  );
  ...
  useEffect(() => {
    productService.getProductById(id!)
      .then(({product}: ProductApiResults) => {
        productDispatch(new ProductAction(productActions.PRODUCT_SUCCESS_PRODUCT, product!))
      })
  },[id])
